...
| 단계 | 작업 | 완료 기준 |
|------|------|----------|
| 1 | 시스템 현황 파악 | API, 동시성 제어, 인덱스 현황 문서화 |
| 2 | 테스트 계획 수립 | 본 문서 작성 |
| 3 | k6 설치 및 환경 준비 | k6 설치, 샘플 스크립트 실행 |
| 4 | 테스트 데이터 준비 | 사용자, 상품, 쿠폰 데이터 생성 |
| 5 | 테스트 스크립트 작성 | 5개 시나리오 스크립트 완성 |
| 6 | 부하 테스트 실행 | 시나리오별 테스트 실행 및 결과 수집 |
| 7 | 결과 분석 및 개선 |  병목 식별, 개선안 도출 |
